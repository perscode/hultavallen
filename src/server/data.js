            ...
            seeds: [
                {
                    ...
                    cultivation: 'Blötläggs i hett vatten 1 dygn före sådd. Låt svalna. Sås inomhus i planteringsjord '+
                                 'blandad med 1/4 torv och 1/4 perlit eller finkornigt grus.' +
                                 ...
                                 'kylskåp ca 1 månad, därefter rumstemperatur. Övervintras i ca 15 gr. Använd kalkfritt vatten.'+
                                 'Om kamelian får torka ut så faller knopparna av. Jorden får inte heller bli för blöt, '+
                                 ...
                                 'Kamelian trivs inte i direkt solsken, men måste ha en så ljus växtplats som möjligt. '+
                                 'Krukan ska inte vridas för då kan knopparna ramla av. För att blomknoppar ska bildas '+
                                 'bör temperaturen på vintern vara omkring 10 °C. Omplantering och beskärning '+
                ...
                },
                {
                    ...
                    cultivation: 'Blötlägg fröerna ett dygn före sådd. Förkultiveras inomhus i planteringsjord '+
                                 ...
                                 'Placeras i 20-25 grader, ljust och svalt efter groning. Utplanteras efter avhärdning '+
